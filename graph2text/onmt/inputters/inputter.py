...
from onmt.inputters.text_dataset import text_fields, node_fields, TextMultiField, GraphField, PlanField, TreeField
...
def get_fields(
    ...
    plan_field_kwargs = {"base_name": "plan"}
    
    fields["plan"] = PlanField(plan_field_kwargs)
    
    tree_field_kwargs = {"base_name": "tree"}
    
    fields["tree"] = TreeField(tree_field_kwargs)
