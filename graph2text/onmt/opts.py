...
def model_opts(parser):
    ...
    group.add('--use_tree', '-use_tree', action='store_true',
              help="Whether to use tree decoder")
              
    group.add('--tgt_word_vec_size', '-tgt_word_vec_size',
              type=int, default=500,
              help='Word embedding size for tgt.')
    group.add('--tree_hid_him', '-tree_hid_him',
              type=int, default=512,
              help='Hidden dimention within tree decoder.')
    group.add('--tree_dropout', '-tree_dropout',
              type=int, default=0.15,
              help='Dropout within tree decoder.')
    ...
    group.add('--dec_plan_layers', '-dec_plan_layers', type=int, default=2,
              help='Number of layers in the plan decoder')
...
def preprocess_opts(parser):
    ...
    group.add('--train_plan', '-train_plan', required=True, nargs='+',
          help="Path(s) to the training plan data")
    group.add('--train_tree', '-train_tree', required=True, nargs='+',
          help="Path(s) to the training tree data")
    ...
    group.add('--valid_plan', '-valid_plan',
              help="Path to the validation plan data")
    group.add('--valid_tree', '-valid_tree',
              help="Path to the validation plan data")
